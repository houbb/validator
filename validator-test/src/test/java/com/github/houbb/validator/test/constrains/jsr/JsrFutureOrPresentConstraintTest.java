 ...
 * @since 0.5.0
 */
public class JsrFutureOrPresentConstraintTest {
    ...
    public void assertFalseTest() {
        ...
        IResult result1 = ValidHelper.failOver(pastTime, Constraints.futureOrPresent(currentTime));
        Assert.assertFalse(result1.pass());

        // 取系统默认时间
        IResult result2 = ValidHelper.failOver(pastTime, Constraints.futureOrPresent());
    ...
    public void assertTrueTest() {
        ...
        IResult result1 = ValidHelper.failOver(futureTime, Constraints.futureOrPresent(currentTime));
        Assert.assertTrue(result1.pass());


        // 取系统默认时间
        IResult result2 = ValidHelper.failOver(futureTime, Constraints.futureOrPresent());
        Assert.assertTrue(result2.pass());

        // 相等
        IResult resultEquals = ValidHelper.failOver(currentTime, Constraints.futureOrPresent(currentTime));
