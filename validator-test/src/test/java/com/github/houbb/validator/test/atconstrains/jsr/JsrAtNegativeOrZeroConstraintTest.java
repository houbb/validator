...
import com.github.houbb.validator.test.atconstrains.bean.JsrAtNegativeOrZeroBo;
 ...
 * @since 0.5.0
 */
public class JsrAtNegativeOrZeroConstraintTest {

    @Test
    public void assertTrueTest() {
        JsrAtNegativeOrZeroBo bo = new JsrAtNegativeOrZeroBo();
        bo.setIntVal(0);
        bo.setStringVal("-1");
